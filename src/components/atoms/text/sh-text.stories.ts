...
export const Paragraphs: Story = {
    ...
    render: (args) => `
        <div style="display: flex; flex-direction: column; gap: 1rem; padding: 2rem; max-width: 600px;">
...
export const ContentExample: Story = {
    ...
    render: (args) => `
        <div style="display: flex; flex-direction: column; gap: 1.5rem; padding: 2rem; max-width: 700px;">
