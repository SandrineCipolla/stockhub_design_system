/* Types générés automatiquement depuis tokens.json */
...
export const designTokens = {
  "color": {
    ...
    "warning": {
      ...
      "500": {
        "value": "#f59e0b",
        "type": "color",
        "description": "Couleur d'avertissement"
      },
      "600": {
        "value": "#d97706",
        "type": "color"
  ...
  "typography": {
    "fontFamily": {
      "base": {
        ...
        "type": "fontFamily",
        "description": "Police principale de l'interface"
      },
      "mono": {
  ...
  "border": {
    "radius": {
      ...
      "full": {
        "value": "9999px",
        "type": "borderRadius",
        "description": "Bordure complètement arrondie"
      }
    },
    "width": {
      "thin": {
  ...
  "shadow": {
    ...
    "purple": {
      "value": "0 10px 15px -3px rgba(139, 92, 246, 0.1), 0 4px 6px -4px rgba(139, 92, 246, 0.1)",
      "type": "boxShadow",
      "description": "Ombre avec teinte violette"
    },
    "purpleLg": {
      "value": "0 20px 25px -5px rgba(139, 92, 246, 0.25), 0 8px 10px -6px rgba(139, 92, 246, 0.1)",
      "type": "boxShadow"
    },
    "dark": {
      "sm": {
      ...
      "md": {
        "value": "0 4px 6px -1px rgba(0, 0, 0, 0.4), 0 2px 4px -2px rgba(0, 0, 0, 0.3)",
        "type": "boxShadow"
      },
      "lg": {
      ...
      "2xl": {
        "value": "0 25px 50px -12px rgba(0, 0, 0, 0.6)",
        "type": "boxShadow"
      },
      "purple": {
        "value": "0 10px 15px -3px rgba(139, 92, 246, 0.3), 0 4px 6px -4px rgba(139, 92, 246, 0.2)",
        "type": "boxShadow"
      },
      "purpleLg": {
        "value": "0 20px 25px -5px rgba(139, 92, 246, 0.4), 0 8px 10px -6px rgba(139, 92, 246, 0.3)",
        "type": "boxShadow"
      }
    }
  },
  "transition": {
    "duration": {
      ...
      "normal": {
        "value": "250ms",
        "type": "duration",
        "description": "Transition normale"
      },
      "slow": {
        "value": "350ms",
        "type": "duration",
        "description": "Transition lente"
      }
    },
    "timing": {
      "ease": {
